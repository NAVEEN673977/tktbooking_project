...
public class BookingStatuss {
	private int bookingStatusId;
	private String bookingStatusCode;
	private String description;
	private String displayName;
	public BookingStatuss() {
		
	}
	public BookingStatuss(int bookingStatusId, String bookingStatusCode, String description, String displayName) {
		super();
